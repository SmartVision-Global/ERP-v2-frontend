...
import {
  ...
  RenderCellUsername,
  RenderCellCreatedAt,
  RenderCellEmployerCode,
} from '../agencies-table-row';
...
export function AgenciesListView() {
  ...
  const columns = [
    ...
    },
    {
      ...
      renderCell: (params) => (
        // <RenderCellProduct params={params} href={paths.dashboard.product.details(params.row.id)} />
        <RenderCellAddress params={params} href={paths.dashboard.root} />
      ),
    },
    {
      field: 'employer_code',
      headerName: 'Code Employer',
      flex: 1,
      minWidth: 160,
      type: 'singleSelect',
      editable: true,
      valueOptions: SEX_OPTIONS,
      renderCell: (params) => <RenderCellEmployerCode params={params} />,
    },
...

    {
      ...
      getActions: (params) => [
        ...
        <GridActionsLinkItem
          ...
          href={paths.dashboard.rh.rhSettings.editAgencies(params.row.id)}
        />,
        // <GridActionsCellItem
        //   showInMenu
        ...
        <CustomBreadcrumbs
          ...
          action={
            <Button
              ...
              href={paths.dashboard.rh.rhSettings.newAgencies}
              variant="contained"
